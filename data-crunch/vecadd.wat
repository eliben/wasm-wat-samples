...
(module
    ...
    (func $do_add (export "do_add") (param $start i32) (param $count i32) (param $dest i32)
        ...
        (call $store_element (local.get $dest) (f32.const 0.0) (f32.const 0.0) (f32.const 0.0) (f32.const 0.0))
        ...
        (loop $addloop (block $breakaddloop
            ...
            (call $store_element (local.get $dest) (local.get $x) (local.get $y) (local.get $z) (local.get $w))
    ...
    (func $store_element (param $offset i32) (param $x f32) (param $y f32) (param $z f32) (param $w f32)
